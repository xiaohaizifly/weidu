...
<div class="col-md-12 graphs">
  <div class="xs">
  	<h3>招聘信息</h3>
	<a href="/weidu/admin.php/Recruit/form" class="btn fb1" style="color:white;">添加招聘</a>
			...
			<table class="table table-striped">
				...
				<tbody>
					<?php if(is_array($recruit_list)): foreach($recruit_list as $key=>$recruit): ?><tr>
						 ...
						 <td><?php echo date('Y-m-d H:i:s',$recruit['add_time']);?></td>
						 <td>
						  <a href="/weidu/admin.php/Recruit/form/id/<?php echo ($recruit[recruit_id]); ?>">编辑</a>
						  <a href="/weidu/admin.php/Recruit/delete/id/<?php echo ($recruit[recruit_id]); ?>" onclick="if (!confirm('是否确认删除？')) return false;">删除</a>
						 </td>
